...
結論として筆者はあまりしないしていない。
* 市場がうまく適合する
* それだけでは不十分何ら、政府やコミュニティーなど、他のスーパーマインドが介入できる。
...
* その他にもたまたま世界を破壊してしまう複数のシナリオがある。例えばペーパークリップを作るようSAIに師事して、それ以外はやるなと指示し忘れたら、可能な限りのペーパークリップを作るための原料を入手すべく、地球とその住民を破壊しつくすかもしれない。
...
#### 戦争への使用は戦争犯罪とすべきか？
* 現状では明確なラインはない。北朝鮮ｋらのサイバー攻撃は米国法に強制力はない、パキスタンでのドローン攻撃はパキスタンの法制度の範囲外。
